...
const SlideShow = () => {
  return (
<section className="bg-[rgb(251,251,251)] dark:bg-gray-900">
  <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
    ...
    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
      <img src="https://obs.line-scdn.net/0hihiGgTA1NkdUPiUgi-xJEGxoOjZnWCxOdl0pIHU2byN9EiQUYQhlJCY9a2spDiISdFwqISU-OCJ-CngSOA/w644" alt="mockup" />
    </div>                
  </div>
</section>
  )
